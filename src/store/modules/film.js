...
const actions = {
    ...
    getBannerList({ commit }) {
        axios.get("https://m.maizuo.com/gateway?type=2&cityId=440300&k=2342909",{
            headers: {
                "X-Client-Info":' {"a":"3000","ch":"1002","v":"5.0.4","e":"15611746489234179686472"}',
        ...
        .then( (response) => { 
            ...
            if (res.status === 0) {
                commit({
                    ...
                    // 在这里解决key值相同的错误
                    list: isChangeFilmType ? res.data.films :[...state.filmLish,...res.data.films],
